...
<body>
  ...
  ================================================== -->
		...
		<div class="container marketing">
			...
			<div class="row featurette">
				<div class="col-md-7">
					...
					// 1. 직접 호출하면 session에 설정된 값이 없으므로 null이 나온다.
					// 비정상적인 요청 => 페이지 이동
					
					// 2. 설정한 interval 시간 내에 요청이 없으면 세션의 값이 삭제된다. => null 반환
					// 정상적인 요청이었으나 딴짓을 오래 했음. => 다른 사람일 수도 있음
		...
		<footer class="container">
			...
			<p>
				&copy; SIST class2. &middot; <a href="#">개인정보 보호 정책</a>
				&middot; <a href="#">개인정보 관리 책임자 님이셈</a>
			</p>
		</footer>
	</main>

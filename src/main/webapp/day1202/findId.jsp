...
<!-- 내가만든 CSS -->
<!-- <link rel="stylesheet" type="text/css" href="http://192.168.10.68/jsp_prj/common/css/main_v251031.css"/> -->
...
<div id="wrap">
	...
	입력하신 아이디 [<strong>${param.id}</strong>]는 <span class = "${resultCss}"><c:out value = "${resultMsg}"/></span>
	<c:if test = "${flagId}">

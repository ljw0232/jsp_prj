...
<div id="wrap">
	...
	<a href="#void" onclick="append()"><img src="../common/images/btn_append.png"></a>
	<a href="#void" onclick="remove()"><img src="../common/images/btn_remove.png"></a>
	</div>
	<div id="licenseDiv">
	...
	<input type = "button" value = "GET 전송" class = "btn btn-success" id = "btnGet"/>
	<input type = "button" value = "POST 전송" class = "btn btn-success" id = "btnPost"/>
	</form>
	</div>

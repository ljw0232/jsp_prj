  ...
  ================================================== -->
		...
		<div class="container marketing">
			...
			<div class="row featurette">
				...
				<ul>
				<li>0패턴 사용</li>
				<li><fmt:formatNumber value = "${num}" pattern = "0,000,000"></fmt:formatNumber></li>
				<li>#패턴 사용</li>
				<li><fmt:formatNumber value = "${num}" pattern = "#,###,###"></fmt:formatNumber></li>
				<li>날짜형식</li>
				<li><fmt:formatDate value = "${date}" pattern = "yyyy-MM-dd EEEE a HH:mm:ss"></fmt:formatDate></li>
				</ul>
				</div>
			</div>
			<hr class="featurette-divider">

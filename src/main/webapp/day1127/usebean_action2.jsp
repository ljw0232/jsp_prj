		...
		<div class="container marketing">
			...
			<div class="row featurette">
				<div class="col-md-7">
					...
					scope 객체
					- page(pageContext)
					  - 페이지가 요청될 때마다 객체가 생성된다.
					  - 생성된 객체는 현재 페이지에서만 사용된다.
					- request
					  - 페이지가 요청될 때마다 객체가 생성된다.
					  - 생성된 객체는 현재 페이지와 forward로 이동한 페이지에서 사용된다.
					- session
					  - 접속자(웹 브라우저)마다 하나의 객체가 생성된다.
					  - 생성된 객체는 모든 JSP 페이지에서 사용될 수 있다.
					- application
					  - 최초 접속자에 의해 하나의 객체가 생성된다.
					...
					당신은 이 페이지에 
					<%
					String cnt = String.valueOf(counter.getCnt()); // <jsp:getProperty property = "cnt" name = "counter"/>

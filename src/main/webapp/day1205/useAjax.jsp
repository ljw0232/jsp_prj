  ...
  ================================================== -->
		...
		<div class="container marketing">
			...
			<div class="row featurette">
				<div class="col-md-7">
					<input type = "button" value = "HTML 요청" class = "btn btn-success" id = "btnHTML"/>
					<input type = "button" value = "TEXT 요청" class = "btn btn-warning" id = "btnTEXT"/>
					<input type = "button" value = "XML 요청" class = "btn btn-info" id = "btnXML"/>
					<input type = "button" value = "JSON 요청" class = "btn btn-primary" id = "btnJSON"/>
					<div id = "output"></div>
				</div>
			</div>
			<hr class="featurette-divider">

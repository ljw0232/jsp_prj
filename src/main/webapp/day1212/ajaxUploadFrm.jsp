...
$(function() {
	...
	$("#btnFileUpload").click(function() {
		...
		$.ajax({
			...
			processData: false, // ajax 요청에 대해서 query string 붙지 않게 막기
			type: "post",
			...
			success: function(jsonObj) {
				if(jsonObj.resultFlag) {
					...
					alert("이미지 업로드에 실패하였습니다. 관리자에게 문의하세요.");
				}
			}
		...
		<div class="container marketing">
			...
			<div class="row featurette">
				<div class="col-md-7">
					<h2>AJAX 파일 업로드</h2>
					<!-- 
					"application/x-www-wform-urlencoded"
					파라메터 전송방식
					"multipart/form-data"
					binary 전송방식
					 -->
					...
					<input type = "button" value = "정보 입력" id = "btnUpload" class = "btn btn-success btn-sm"/><br>
					</form>
				</div>
			</div>
			<hr class="featurette-divider">
